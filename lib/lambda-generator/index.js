...
module.exports = {
  ...
  generateLambdaFromCommand: ({ command, database, service }) => {
    ...
    return { fn: generate(parsed, parsed.options.paramTypes, database, parsed.collection, service), variables: parsed.variables, options: parsed.options, database, collection: parsed.collection };
  }
};
